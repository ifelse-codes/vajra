...
| S168-release | **Waits for S168 merge + founder go** | **Release vajractl 0.2.0 = S167 + S168 together** (S167 AC10 · S168 AC13 · plan step 11). Session 168 shipped a demo that cannot be faked; nobody outside this repo has it until this release. Same order as below. |
...
| S170 | Mandatory | **NO-CODE Ground Truth** (170 % 5 == 0). |
