...
| S175 | **Next — drafted, founder's pick pending** | Mandatory NO-CODE Ground Truth (175 % 5 == 0), drafted from S174's candidate 1: rudra session 06 as the evidence that S174's fixes land, plus brief audits. Brief: `prompts/175-task-ground-truth.md` (DRAFT). Alternatives: GT on the 0.2.0 release; GT on the close's paperwork. |
