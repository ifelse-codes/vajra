...
| S171 | **Next — interactive** | **Built from the founder's own testing** (`prompts/171-task-interactive.md`, DRAFT): he brings findings, we write/edit the prompt together, then short check-in loops. |
