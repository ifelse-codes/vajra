...
## Active Branch
None — between sessions (S02 complete, S03 not yet started).
...
- Single-integer SoT at `.ai/SESSION` (= 02).
...
- Compression heuristics (cargo, git, pytest, npm, generic)
...
## What Is In Progress
- Between sessions. Start S03 from `sessions/session-02-summary.md` after picking A/B/C/D.
